...
export default {
  ...
  data () {
    return {
      ...
      // 获取得到的历史记录
      // sections: [
      //   { time: '2025-04-12T18:18:01', confidence_score: 0, text: '内容文本2025-04-03T02:18:01', bic: '虚假', multicls: '篡改事实', token: { 2: '文', 3: '本' }, img: 'https://iph.href.lu/300x200?fg=666666&bg=cccccc', description: '注释' },
      //   { time: '2025-04-12T18:18:01', confidence_score: 10, text: '内容文本2025-04-03T02:18:01', bic: '虚假', multicls: '篡改事实', token: { 2: '文', 3: '本' }, img: 'https://iph.href.lu/300x200?fg=666666&bg=cccccc', description: '注释' },
      //   { time: '2025-04-12T18:18:01', confidence_score: 15, text: '内容文本2025-04-03T02:18:01', bic: '虚假', multicls: '篡改事实', token: { 2: '文', 3: '本' }, img: 'https://iph.href.lu/300x200?fg=666666&bg=cccccc', description: '注释' },
      //   { time: '2025-04-12T18:18:01', confidence_score: 20, text: '内容文本2025-04-03T02:18:01', bic: '虚假', multicls: '篡改事实', token: { 2: '文', 3: '本' }, img: 'https://iph.href.lu/300x200?fg=666666&bg=cccccc', description: '注释' },
      ...
      //   { time: '2025-04-08T02:18:01', confidence_score: 80, text: '内容文本2025-04-01T02:18:01', bic: '虚假', multicls: '篡改事实', token: { 2: '文', 3: '本' }, img: 'https://iph.href.lu/300x200?fg=666666&bg=cccccc', description: '注释' },
  ...
  methods: {
    ...
    initSortedChartPie1 () {
      ...
      const colors = ['#c63838', '#FF6F61', '#ff8d6a', '#66BB6A', '#3d8640']
